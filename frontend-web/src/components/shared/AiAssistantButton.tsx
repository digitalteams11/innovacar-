  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-5 right-4 sm:right-6 z-40 w-11 h-11 rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-105
          ${status === 'disabled'
