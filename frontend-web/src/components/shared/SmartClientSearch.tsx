  ...
  return (
    <div ref={containerRef} className="relative">
      <label className="block text-xs font-medium text-slate-500 mb-1">
        {labelText}{required && <span className="text-danger-500 ms-0.5">*</span>}
      </label>
      <div className="relative">
        ...
        <input
          ...
          className="w-full ps-10 pe-4 py-2.5 bg-[#f5f5f0] border border-[#e8e6e1] rounded-xl text-sm focus:outline-none focus:ring-2 ring-brand-100 focus:bg-white focus:border-brand-300 transition-all"
        />
      </div>
