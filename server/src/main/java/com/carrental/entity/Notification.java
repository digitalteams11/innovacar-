...
public class Notification {
    ...
    public enum NotificationType {
        ...
        // Additional driver signatures (independent of the main client/agency signature)
        ADDITIONAL_DRIVER_LINK_SENT, ADDITIONAL_DRIVER_OPENED, ADDITIONAL_DRIVER_SIGNED,
        ADDITIONAL_DRIVER_DECLINED, ADDITIONAL_DRIVER_LINK_EXPIRED,
        // Reservations
