  ...
  return (
    <div className="space-y-6 animate-fade">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Trial Signups (30d)" value={conversion?.trialsCreated || 0} icon={Users} loading={loading} />
        <StatCard title="Trial-to-Paid Rate" value={`${conversion?.trialToPaidRate || 0}%`} icon={TrendingUp} loading={loading} />
        <StatCard title="Avg. Onboarding Time" value={`${conversion?.avgOnboardingMinutes || 0}m`} icon={Target} loading={loading} />
        <StatCard title="Landing Page CTR" value={`${conversion?.landingCTR || 0}%`} icon={Megaphone} loading={loading} />
      </div>
