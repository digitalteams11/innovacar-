...
module.exports = {
  ...
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
    // The real renderer source is shared from frontend-web/src (see
    // src/main.tsx) — Tailwind must scan it directly to generate classes.
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Full 50-900 scales — must match frontend-web/tailwind.config.cjs
        // exactly, since desktop renders frontend-web's shared components,
        // which reference shades like text-success-700/danger-300/warning-800.
        success: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
